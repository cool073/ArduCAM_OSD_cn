...
[Serializable]
public class Tuple<T1, T2, T3, T4, T5, T6, T7, T8> : IStructuralEquatable, IStructuralComparable, IComparable, ITuple
{
    // Fields
    ...
    int IStructuralComparable.CompareTo(object other, IComparer comparer)
    {
        ...
        Tuple<T1, T2, T3, T4, T5, T6, T7, T8> tuple = other as Tuple<T1, T2, T3, T4, T5, T6, T7, T8>;
        if (tuple == null)
        {
        ...
        return comparer.Compare(this.m_Item8, tuple.m_Item8);
    }
