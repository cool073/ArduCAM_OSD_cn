...
namespace OSD
{
    public partial class OSD : Form
    {
        ...
        Panels pan;
        int nosdfunctions=0;
        Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[] panelItems = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[32];
        Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[] panelItems_default = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[32];
        Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[] panelItems2 = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[32];
        Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[] panelItems2_default = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>[32];
        ...
        // 更新单位显示
        void UpdateUnitsShow(int unit_type)
        {
            if (unit_type == 1)
            {
                // 英制
                STALL_label.Text = "失速值(mph)";
                OVERSPEED_label.Text = "过速值(mph)";
            }
            else
            {
                // 公制
                STALL_label.Text = "失速值(km/h)";
                OVERSPEED_label.Text = "过速值(km/h)";
            }
        }
        //Set item boxes
        void setupFunctions()
        {
            ...
            // first 8
            // name,printfunction,X,Y,ENaddress,Xaddress,Yaddress,Display name
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Center", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR, "中心点标志");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Pitch", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR, "俯仰");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Roll", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR, "横滚");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery A", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR, "电池电压");
            //items[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery B", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR, "电池电压B");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Visible Sats", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR,"GPS卫星数");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("GPS Lock", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR, "GPS定位状态");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("GPS Coord", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR, "GPS坐标");

            //second 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heading Rose", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR, "航向指示器");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heading", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR, "航向");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heart Beat", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR, "MAV闪动指示器");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Direction", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR, "起飞点方向");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Distance", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR, "起飞点距离");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("WP Direction", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR, "航点方向");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("WP Distance", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR, "航点距离");
            // rssi

            // third 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Altitude", pan.panAlt, 22, 3, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR, "高度计读数");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Altitude", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR, "相对起飞点高度");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Climb Rate", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR, "爬升速度");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery Percent", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR, "电池剩余百分比");
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Current", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR, "电流");
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Velocity", pan.panVel, 1, 2, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR, "地速");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Air Speed", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR, "空速");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Throttle", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR, "油门");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Flight Mode", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR, "飞行模式");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Horizon", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR, "地平线");
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Wind Speed", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR, "风速");
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Warnings", pan.panWarn, 9, 4, panWarn_en_ADDR, panWarn_x_ADDR, panWarn_y_ADDR, "警告信息");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Time", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR, "时间");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("RSSI", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR, "RSSI");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Tune", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR, "调试");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Efficiency", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR, "效率");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Call Sign", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR, "呼号");
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Channel Raw", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR, "遥控器通道数据");
            ...
            foreach (var thing in panelItems)
            {
                if (thing != null)
                {
                    ...
                    {
                        LIST_items.Items.Add(thing.Item8, false);
                    ...
                    {
                        LIST_items.Items.Add(thing.Item8, true);
                    }
                }
            }
            ...
            // first 8
            // name,printfunction,X,Y,ENaddress,Xaddress,Yaddress,Display name
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Center", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR, "中心点标志");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Pitch", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR, "俯仰");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Roll", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR, "横滚");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery A", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR, "电池电压");
            //items[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery B", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR, "电池电压B");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Visible Sats", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR, "GPS卫星数");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("GPS Lock", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR, "GPS定位状态");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("GPS Coord", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR, "GPS坐标");

            //second 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heading Rose", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR, "航向指示器");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heading", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR, "航向");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Heart Beat", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR, "MAV闪动指示器");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Direction", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR, "起飞点方向");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Distance", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR, "起飞点距离");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("WP Direction", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR, "航点方向");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("WP Distance", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR, "航点距离");
            // rssi

            // third 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Altitude", pan.panAlt, 22, 3, panAlt_en_ADDR, panAlt_x_ADDR, panAlt_y_ADDR, "高度计读数");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Home Altitude", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR, "相对起飞点高度");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Climb Rate", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR, "爬升速度");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Battery Percent", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR, "电池剩余百分比");

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Current", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR, "电流");

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Velocity", pan.panVel, 1, 2, panVel_en_ADDR, panVel_x_ADDR, panVel_y_ADDR, "地速");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Air Speed", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR, "空速");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Throttle", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR, "油门");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Flight Mode", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR, "飞行模式");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Horizon", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR, "地平线");

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Wind Speed", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR, "风速");

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Warnings", pan.panWarn, 9, 4, panWarn_en_ADDR, panWarn_x_ADDR, panWarn_y_ADDR, "警告信息");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Time", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR, "时间");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("RSSI", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR, "RSSI");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Tune", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR, "调试");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Efficiency", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR, "效率");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Call Sign", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR, "呼号");
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>("Channel Raw", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR, "遥控器通道数据");
            ...
            foreach (var thing in panelItems2)
            {
                if (thing != null)
                {
                    ...
                    if (thing.Item1 == "Center")
                    {
                        LIST_items2.Items.Add(thing.Item8, false);
                    ...
                    {
                        LIST_items2.Items.Add(thing.Item8, true);
                    }
                }
            }
            ...
            RSSI_numeric_min.Value = pan.rssimin;
            RSSI_numeric_max.Value = pan.rssimax;
            ...
            if (CMB_ComPort.Items.Count > 0) CMB_ComPort.SelectedIndex=0;
        }          
            ...
            foreach (string it in list)
            {
                foreach (var thing in panelItems)
                {
                    ...
                    if (thing != null)
                    {
                        if (thing.Item8 == it)
                        {
                            if (thing.Item8 == currentlyselected[0])
                            {
                                selectedrectangle = true;
                            }

                            processingpanel = thing.Item8;
            ...
            foreach (string it in list)
            {
                foreach (var thing in panelItems2)
                {
                    ...
                    if (thing != null)
                    {
                        if (thing.Item8 == it)
                        {
                            if (thing.Item8 == currentlyselected[1])
                            {
                                selectedrectangle = true;
                            }
        ...
        private void checkedListBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (((CheckedListBox)sender).SelectedItem != null)
                item = ((CheckedListBox)sender).SelectedItem.ToString();
            ...
            foreach (var thing in panelItems)
            {
                if (thing != null && thing.Item8 == item)
                {
        ...
        {
            if (((CheckedListBox)sender).Text == "地平线")
            {
        ...
        {
            // if (((CheckedListBox)sender).SelectedItem != null && ((CheckedListBox)sender).SelectedItem.ToString() == "地平线")
            if (((CheckedListBox)sender).SelectedItem != null)
            {
                if (((CheckedListBox)sender).SelectedItem.ToString() == "地平线" && e.NewValue == CheckState.Checked)
                {
                    int index = LIST_items.Items.IndexOf("中心点标志");
                    LIST_items.SetItemChecked(index, false);
                }
                else if (((CheckedListBox)sender).SelectedItem.ToString() == "中心点标志" && e.NewValue == CheckState.Checked)
                {
                    int index = LIST_items.Items.IndexOf("地平线");
                    LIST_items.SetItemChecked(index, false);
                }
            }
        ...
        private void checkedListBox2_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            if (((CheckedListBox)sender).SelectedItem != null)
            {
                if (((CheckedListBox)sender).SelectedItem.ToString() == "地平线" && e.NewValue == CheckState.Checked)
                {
                    int index = LIST_items2.Items.IndexOf("中心点标志");
                    LIST_items2.SetItemChecked(index, false);
                }
                else if (((CheckedListBox)sender).SelectedItem.ToString() == "中心点标志" && e.NewValue == CheckState.Checked)
                {
                    int index = LIST_items2.Items.IndexOf("地平线");
                    LIST_items2.SetItemChecked(index, false);
                }
            }
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (panelItems[a] != null && panelItems[a].Item8 == item)
                {
                    panelItems[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems[a].Item1, panelItems[a].Item2, (int)NUM_X.Value, panelItems[a].Item4, panelItems[a].Item5, panelItems[a].Item6, panelItems[a].Item7, panelItems[a].Item8);
                }
            }
        ...
        private void numericUpDown2_ValueChanged(object sender, EventArgs e)
        {
            ...
            for (int a = 0; a < panelItems.Length; a++)
            {
                if (panelItems[a] != null && panelItems[a].Item8 == item)
                {
                    panelItems[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems[a].Item1, panelItems[a].Item2, panelItems[a].Item3, (int)NUM_Y.Value, panelItems[a].Item5, panelItems[a].Item6, panelItems[a].Item7, panelItems[a].Item8);
        ...
        private void numericUpDown3_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (panelItems2[a] != null && panelItems2[a].Item8 == item)
                {
                    panelItems2[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems2[a].Item1, panelItems2[a].Item2, (int)NUM_X2.Value, panelItems2[a].Item4, panelItems2[a].Item5, panelItems2[a].Item6, panelItems2[a].Item7, panelItems2[a].Item8);
                }
            }
        ...
        private void numericUpDown4_ValueChanged(object sender, EventArgs e)
        {
            ...
            for (int a = 0; a < panelItems2.Length; a++)
            {
                if (panelItems2[a] != null && panelItems2[a].Item8 == item)
                {
                    panelItems2[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems2[a].Item1, panelItems2[a].Item2, panelItems2[a].Item3, (int)NUM_Y2.Value, panelItems2[a].Item5, panelItems2[a].Item6, panelItems2[a].Item7, panelItems2[a].Item8);
        ...
        private void BUT_WriteOSD_Click(object sender, EventArgs e)
        {
            ...
            if (current.Name == "tabPage1") 
            {
                ...
                foreach (string str in this.LIST_items.Items)
                {
                    ...
                    {
                        if ((tuple != null) && ((tuple.Item8 == str)) && tuple.Item5 != -1)
                        {
            ...
            else if (current.Name == "tabPageConfig") 
            {
                //Setup configuration panel
                ...
                eeprom[OSD_RSSI_HIGH_ADDR] = pan.rssimax;
                eeprom[OSD_RSSI_LOW_ADDR] = pan.rssimin;
                ...
                for (int i = 0; i < pan.callsign_str.Length; i++)
                {
                    ...
                    Console.WriteLine("Call Sign " + i + " is " + (char)eeprom[OSD_CALL_SIGN_ADDR + i]);
                }
            ...
            catch { MessageBox.Show("打开串口出错！", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error); return; }
                ...
                try
                {
                    ...
                    if (current.Name == "tabPage1") {
                        ...
                        { //try to upload two times if it fail
                            ...
                            if (!spupload_flag) {
                                if (sp.keepalive()) Console.WriteLine("保持连接成功(第" + i + "次)！");
                                else Console.WriteLine("保持连接失败(第" + i + "次)！");
                            } 
                            else break;
                        }
                        if (spupload_flag) MessageBox.Show("写入“面板1”数据成功！");
                        else MessageBox.Show("写入“面板1”数据失败！");
                    }
                    else if (current.Name == "tabPage2")
                    {
                        for (int i = 0; i < 10; i++)
                        ...
                        if (spupload_flag) MessageBox.Show("写入“面板2”数据成功！");
                        else MessageBox.Show("写入“面板2”数据失败！");
                    }
                    else if (current.Text == "配置")
                    {
                        for (int i = 0; i < 10; i++)
                        { //try to upload two times if it fail
                        ...
                        if (spupload_flag) MessageBox.Show("写入“配置”数据成功！");
                        else MessageBox.Show("写入“配置”数据失败！");
                    } 
                }                 
                catch (Exception ex) {
            ...
            {
                MessageBox.Show("与bootloader握手失败！");
            }
        ...
        private void BUT_ResetOSD_EEPROM()
        {
            ...
            for (int i = 0; i < OSD_CALL_SIGN_TOTAL; i++)
            {
                ...
                Console.WriteLine("Call Sign read " + i + " is " + (char)eeprom[OSD_CALL_SIGN_ADDR + i]);
            }
        ...
        private void BUT_ReadOSD_Click(object sender, EventArgs e)
        {
            ...
            if (eeprom[CHK_VERSION] != VER) { // no match
                MessageBox.Show("EEPROM数据格式版本过旧！将自动更新到新版数据格式的默认设置。", "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                BUT_ResetOSD_EEPROM(); //write defaults
                MessageBox.Show("EEPROM数据更新成功！", "提示信息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            if (!fail)
            {
                ...
                for (int a = 0; a < panelItems.Length; a++)
                {
                    if (panelItems[a] != null)
                    {
                        ...
                        if (panelItems[a].Item7 >= 0 || panelItems[a].Item6 >= 0)
                            panelItems[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems[a].Item1, panelItems[a].Item2, eeprom[panelItems[a].Item6], eeprom[panelItems[a].Item7], panelItems[a].Item5, panelItems[a].Item6, panelItems[a].Item7, panelItems[a].Item8);
                    }
                }
                //Second panel
                for (int a = 0; a < panelItems2.Length; a++)
                {
                    if (panelItems2[a] != null)
                    {
                        ...
                        if (panelItems2[a].Item7 >= 0 || panelItems[a].Item6 >= 0)
                            panelItems2[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems2[a].Item1, panelItems2[a].Item2, eeprom[panelItems2[a].Item6 + OffsetBITpanel], eeprom[panelItems2[a].Item7 + OffsetBITpanel], panelItems2[a].Item5, panelItems2[a].Item6, panelItems2[a].Item7, panelItems2[a].Item8);
                    }
                }
            }
            ...
            pan.rssimax = eeprom[OSD_RSSI_HIGH_ADDR];
            RSSI_numeric_max.Value = pan.rssimax;

            pan.rssimin = eeprom[OSD_RSSI_LOW_ADDR];
            RSSI_numeric_min.Value = pan.rssimin;
            ...
            if (sp.down_flag) MessageBox.Show("下载数据完成！");
            else MessageBox.Show("下载数据失败！");
            sp.down_flag = false;
            ...
            if (sfd.FileName != "")
            {
                try
                {
                    ...
                    //Write
                    {
                        ...
                        {
                            if (item != null)
                                sw.WriteLine("{0}\t{1}\t{2}\t{3}", item.Item1, item.Item3, item.Item4, LIST_items.GetItemChecked(LIST_items.Items.IndexOf(item.Item8)).ToString());
                        }
                        //Panel 2
                        ...
                        {
                            if (item != null)
                                sw.WriteLine("{0}\t{1}\t{2}\t{3}", item.Item1, item.Item3, item.Item4, LIST_items2.GetItemChecked(LIST_items2.Items.IndexOf(item.Item8)).ToString());
                        }
                        //Config 
                        ...
                        sw.WriteLine("{0}\t{1}", "RSSI High", pan.rssimax);
                        sw.WriteLine("{0}\t{1}", "RSSI Low", pan.rssimin);
                ...
                try
                {
                    using (StreamReader sr = new StreamReader(ofd.OpenFile()))
                    {
                        ...
                        for( int i = 0; i < nosdfunctions; i++)
                        {
                            ...
                            for (int a = 0; a < panelItems.Length ; a++)
                            {
                                if (panelItems[a] != null && panelItems[a].Item1 == strings[0])
                                {
                                    ...
                                    try
                                    {
                                        panelItems[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems[a].Item1, panelItems[a].Item2, int.Parse(strings[1]), int.Parse(strings[2]), panelItems[a].Item5, panelItems[a].Item6, panelItems[a].Item7, panelItems[a].Item8);
                        ...
                        for (int i = 0; i < nosdfunctions; i++)
                        {
                            ...
                            for (int a = 0; a < panelItems.Length; a++)
                            {
                                if (panelItems2[a] != null && panelItems2[a].Item1 == strings[0])
                                {
                                    ...
                                    try
                                    {
                                        panelItems2[a] = new Tuple<string, Func<int, int, int>, int, int, int, int, int, string>(panelItems2[a].Item1, panelItems2[a].Item2, int.Parse(strings[1]), int.Parse(strings[2]), panelItems2[a].Item5, panelItems2[a].Item6, panelItems2[a].Item7, panelItems2[a].Item8);
                        ...
                        while (!sr.EndOfStream)
                        {
                            ...
                            else if (strings[0] == "RSSI High") pan.rssimax = byte.Parse(strings[1]);
                            else if (strings[0] == "RSSI Low") pan.rssimin = byte.Parse(strings[1]);
        ...
        {
            pan.rssimin = (byte)RSSI_numeric_min.Value;
        }

        private void RSSI_numeric_max_ValueChanged(object sender, EventArgs e)
        {
            pan.rssimax = (byte)RSSI_numeric_max.Value;
        }
